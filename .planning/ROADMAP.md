...
Plans:
- [x] 08-01-PLAN.md — Design tokens: correct wood gradient colors, aged-gold, heading/error font sizes in tailwind.config.ts + globals.css
- [x] 08-02-PLAN.md — BookSpine: height 150→200px, both font sizes to 14px, remove author opacity
...
- [x] 08-04-PLAN.md — Page corrections: Library/AddBook headings 32px, add button color, input focus border, swatch selection border, Save button color
...
| 8. UI Faithful Port | v2.0 | 3/4 | In Progress|  |
