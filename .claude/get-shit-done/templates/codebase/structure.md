...
- Usage: Reference from command with `@/Users/anish/Developer/Personal/LibM/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/anish/Developer/Personal/LibM/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/anish/Developer/Personal/LibM/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
