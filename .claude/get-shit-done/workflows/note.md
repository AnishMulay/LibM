...
- **Global scope**: `/Users/anish/Developer/Personal/LibM/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/anish/Developer/Personal/LibM/.claude/notes/`)
...
2. Glob `/Users/anish/Developer/Personal/LibM/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/anish/Developer/Personal/LibM/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/anish/Developer/Personal/LibM/.claude/notes/` — works in any directory
